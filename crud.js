...
con.connect(function(err) {
  ...
  var sql = "INSERT INTO customers (name, password,city) VALUES ('purnima','Purnima@123','bihar')";
...
app.listen(3500,()=>{
    console.log("listing the port at 3500 with express")
})
app.get("/get",(req,res)=>{
...
app.post('/post',(req,res)=>{
  con.query("insert into customers set ?",[req.body],function(err,result){
    if(err){
      console.log(err)
    }else{
